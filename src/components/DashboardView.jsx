...
export default function DashboardView({
  habits, todayIdx, oPct, cStreak, lStreak, consist, xp, level, nextLvl, xpPct, status, dailyPcts, hPct, streakFor,
}) {
  return (
    <div style={{ display:"flex", flexDirection:"column", gap:16 }}>
      ...
      <div style={{ ...card, background:"linear-gradient(135deg,#f8c4d8,#eda8c8)", padding:"20px" }}>
        ...
        {nextLvl && (
          <div style={{ marginTop:14 }}>
            ...
            <div style={{ fontSize:10, color:"#a03060", fontFamily:"sans-serif", marginTop:4 }}>
        ...
        <div style={card}>
          ...
          {[
            ...
            <div key={s.label} style={{ background:"#fde8f0", borderRadius:9, padding:"8px 12px", marginBottom:6 }}>
              <div style={{ fontSize:10, color:"#a03060", fontFamily:"sans-serif", marginBottom:1, display:"flex", alignItems:"center", gap:4 }}>
                <span style={{ color:"#c04070" }}>{s.icon}</span> {s.label}
              </div>
      ...
      <div style={{ ...card, background:"linear-gradient(135deg,#f8c4d8,#f0dcea)", textAlign:"center", padding:"24px" }}>
        ...
        <div style={{ fontSize:13, color:"#a03060", fontFamily:"sans-serif", marginBottom:12 }}>
        ...
        <div style={{ fontSize:11, color:"#c06080", fontFamily:"sans-serif", fontStyle:"italic" }}>
